...
#Region "Public Interface"
        ...
        ''' <remarks></remarks>
        Public Shared Function AppStar(ByVal tjd As float, _
        ...
        ''' >0...Error code from function 'solarsystem'.</pre></returns>
        ''' <remarks></remarks>
        Public Shared Function TopoStar(ByVal tjd As float, _
                                             ByRef earth As BodyDescription, _
        ...
        ''' </pre></returns>
        ''' <remarks></remarks>
        Public Shared Function AppPlanet(ByVal tjd As float, _
        ...
        ''' </pre></returns>
        ''' <remarks></remarks>
        Public Shared Function TopoPlanet(ByVal tjd As float, _
                                               ByRef ss_object As BodyDescription, _
                                               ByRef earth As BodyDescription, _
                                               ByVal deltat As float, _
                                               ByRef location As SiteInfo, _
        ...
        Public Shared Function VirtualStar(ByVal tjd As float, _
                                                    ByRef earth As BodyDescription, _
                                                    ByRef star As CatEntry, _
                                                    ByRef ra As float, _
                                                    ByRef dec As float) As Short
        ...
        '''</pre></returns>
        ''' <remarks></remarks>
        Public Shared Function LocalStar(ByVal tjd As float, _
                                                  ByRef earth As BodyDescription, _
                                                  ByVal deltat As float, _
                                                  ByRef star As CatEntry, _
                                                  ByRef location As SiteInfo, _
        ...
        ''' </pre></returns>
        ''' <remarks></remarks>
        Public Shared Function VirtualPlanet(ByVal tjd As float, _
                                                      ByRef ss_object As BodyDescription, _
                                                      ByRef earth As BodyDescription, _
                                                      ByRef ra As float, _
                                                      ByRef dec As float, _
        ...
        ''' </pre></returns>
        ''' <remarks></remarks>
        Public Shared Function LocalPlanet(ByVal tjd As float, _
                                                    ByRef ss_object As BodyDescription, _
                                                    ByRef earth As BodyDescription, _
                                                    ByVal deltat As float, _
                                                    ByRef location As SiteInfo, _
        ...
        Public Shared Function AstroStar(ByVal tjd As float, _
                                                  ByRef earth As BodyDescription, _
                                                  ByRef star As CatEntry, _
                                                  ByRef ra As float, _
                                                  ByRef dec As float) As Short
        ...
        ''' <remarks></remarks>
        Public Shared Function AstroPlanet(ByVal tjd As float, _
                                                    ByRef ss_object As BodyDescription, _
                                                    ByRef earth As BodyDescription, _
                                                    ByRef ra As float, _
                                                    ByRef dec As float, _
        ...
        ''' refraction.</remarks>
        Public Shared Sub Equ2Hor(ByVal tjd As float, _
                                          ByVal deltat As float, _
                                          ByVal x As float, _
                                          ByVal y As float, _
                                          ByRef location As SiteInfo, _
        ...
        ''' <remarks></remarks>
        Public Shared Sub SiderealTime(ByVal jd_high As float, _
        ...
        Public Shared Sub Precession(ByVal tjd1 As float, ByVal pos As float(), ByVal tjd2 As float, ByRef pos2 As float())
            Dim posv2 As New PosVector2
            If Is64Bit() Then
        ...
        ''' <remarks></remarks>
        Public Shared Sub EarthTilt(ByVal tjd As float, _
        ...
        ''' </remarks>
        Public Shared Sub CelPole(ByVal del_dpsi As float, _
        ...
        ''' <remarks></remarks>
        Public Shared Function Ephemeris(ByVal tjd As float, _
                                            ByRef cel_obj As BodyDescription, _
                                            ByVal origin As Origin, _
                                            ByRef pos As float(), _
                                            ByRef vel As float()) As Short
            Dim posv As New PosVector2, velv As New VelVector2, rc As Short
            If Is64Bit() Then
        ...
        ''' </returns>
        ''' <remarks></remarks>
        Public Shared Function Vector2RADec(ByVal pos As float(), _
                                                    ByRef ra As float, _
                                                    ByRef dec As float) As Short
            Dim rc As Short
            If Is64Bit() Then
        ...
        ''' <remarks></remarks>
        Public Shared Sub StarVector2s(ByVal star As CatEntry, ByRef pos As float(), ByRef vel As float())
            Dim posv As New PosVector2, velv As New VelVector2
            If Is64Bit() Then
                starVector2s64(CatEntryToCatEntryNOVAS2(star), posv, velv)
            Else
                starVector2s32(CatEntryToCatEntryNOVAS2(star), posv, velv)
            End If
            PosVecToArr(posv, pos)
            VelVecToArr(velv, vel)
        End Sub
        ...
        ''' <remarks></remarks>
        Public Shared Sub RADec2Vector2(ByVal ra As float, _
                                                  ByVal dec As float, _
                                                  ByVal dist As float, _
                                                  ByRef pos As float())
            Dim posv As New PosVector2
            If Is64Bit() Then
                radec2Vector264(ra, dec, dist, posv)
            Else
                radec2Vector232(ra, dec, dist, posv)
            End If
            PosVecToArr(posv, pos)
        End Sub
        ...
        ''' </returns>
        ''' <remarks></remarks>
        Public Shared Function GetEarth(ByVal tjd As float, _
                                                ByRef earth As BodyDescription, _
            ...
            Dim rc As Short
            Dim vbary_earthp, vhelio_earthp As New PosVector2, vbary_earthv, vhelio_earthv As New VelVector2
            If Is64Bit() Then
        ...
        '''</remarks>
        Public Shared Function MeanStar(ByVal tjd As float, _
                                                    ByRef earth As BodyDescription, _
                                                    ByVal ra As float, _
                                                    ByVal dec As float, _
        ...
        Public Shared Sub Pnsw(ByVal tjd As float, _
                                       ByVal gast As float, _
                                       ByVal x As float, _
                                       ByVal y As float, _
                                       ByVal vece As float(), _
                                       ByRef vecs As float())
            Dim vvecs As New PosVector2
            If Is64Bit() Then
        ...
        Public Shared Sub Spin(ByVal st As float, _
                                       ByVal pos1 As float(), _
                                       ByRef pos2 As float())
            Dim vpos2 As New PosVector2
            If Is64Bit() Then
        ...
        Public Shared Sub Wobble(ByVal x As float, _
                                            ByVal y As float, _
                                            ByVal pos1 As float(), _
                                            ByRef pos2 As float())
            Dim vpos2 As New PosVector2
        ...
        ''' <remarks></remarks>
        Public Shared Sub ProperMotion(ByVal tjd1 As float, _
        ...
        Public Shared Sub BaryToGeo(ByVal pos As float(), _
                                              ByVal earthVector2 As float(), _
                                              ByRef pos2 As float(), _
                                              ByRef lighttime As float)
            Dim vpos2 As PosVector2
            If Is64Bit() Then
                bary_to_geo64(ArrToPosVec(pos), ArrToPosVec(earthVector2), vpos2, lighttime)
            Else
                bary_to_geo32(ArrToPosVec(pos), ArrToPosVec(earthVector2), vpos2, lighttime)
            End If
            PosVecToArr(vpos2, pos2)
        End Sub
        ''' <summary>
        ...
        Public Shared Function SunField(ByVal pos As float(), _
                                                 ByVal earthVector2 As float(), _
                                                 ByRef pos2 As float()) As Short
            Dim vpos2 As PosVector2, rc As Short
            If Is64Bit() Then
                rc = sun_field64(ArrToPosVec(pos), ArrToPosVec(earthVector2), vpos2)
            Else
                rc = sun_field32(ArrToPosVec(pos), ArrToPosVec(earthVector2), vpos2)
            End If
            PosVecToArr(vpos2, pos2)
            Return rc
        End Function
        ...
        Public Shared Function Aberration(ByVal pos As float(), _
                                                  ByVal vel As float(), _
        ...
        Public Shared Function Nutate(ByVal tjd As float, _
        ...
        ''' <returns>0...Everything OK.</returns>
        ''' <remarks></remarks>
        Public Shared Function NutationAngles(ByVal tdbtime As float, _
        ...
        ''' <remarks></remarks>
        Public Shared Sub FundArgs(ByVal t As float, _
                                            ByRef a As float())
        ...
        Public Shared Sub Tdb2Tdt(ByVal tdb As float, _
        ...
        ''' <remarks></remarks>
        Public Shared Sub CalDate(ByVal tjd As float, _
        ...
        ''' <remarks></remarks>
        Public Shared Sub SunEph(ByVal jd As float, _
                                               ByRef ra As float, _
                                               ByRef dec As float, _
                                               ByRef dis As float)
            If Is64Bit() Then
...
#Region "DLL Entry Points (32bit)"
        <DllImport(NOVAS32Dll, EntryPoint:="app_star")> Private Shared Function app_star32(ByVal tjd As float, _
                                                                                           ByRef earth As BodyDescriptionShort, _
                                                                                           ByRef star As CatEntryNOVAS2, _
                                                                                           ByRef ra As float, _
                                                                                           ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS32Dll, EntryPoint:="topo_star")> Private Shared Function topo_star32(ByVal tjd As float, _
                                                                                             ByRef earth As BodyDescriptionShort, _
                                                                                             ByVal deltat As float, _
                                                                                             ByRef star As CatEntryNOVAS2, _
                                                                                             ByRef location As SiteInfo, _
                                                                                             ...
                                                                                             ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS32Dll, EntryPoint:="app_planet")> Private Shared Function app_planet32(ByVal tjd As float, _
        ...
        <DllImport(NOVAS32Dll, EntryPoint:="topo_planet")> Private Shared Function topo_planet32(ByVal tjd As float, _
                                                                                                 ByRef ss_object As BodyDescriptionShort, _
                                                                                                 ByRef earth As BodyDescriptionShort, _
                                                                                                 ByVal deltat As float, _
                                                                                                 ByRef location As SiteInfo, _
                                                                                                 ...
                                                                                                 ByRef dis As float) As Short
        End Function
        <DllImport(NOVAS32Dll, EntryPoint:="virtual_star")> Private Shared Function virtual_star32(ByVal tjd As float, _
                                                                                                   ByRef earth As BodyDescriptionShort, _
                                                                                                   ByRef star As CatEntryNOVAS2, _
                                                                                                   ByRef ra As float, _
                                                                                                   ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS32Dll, EntryPoint:="local_star")> Private Shared Function local_star32(ByVal tjd As float, _
                                                                                               ByRef earth As BodyDescriptionShort, _
                                                                                               ByVal deltat As float, _
                                                                                               ByRef star As CatEntryNOVAS2, _
                                                                                               ByRef location As SiteInfo, _
                                                                                               ...
                                                                                               ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS32Dll, EntryPoint:="virtual_planet")> Private Shared Function virtual_planet32(ByVal tjd As float, _
                                                                                                       ByRef ss_object As BodyDescriptionShort, _
                                                                                                       ByRef earth As BodyDescriptionShort, _
                                                                                                       ByRef ra As float, _
                                                                                                       ByRef dec As float, _
                                                                                                       ByRef dis As float) As Short
        End Function
        <DllImport(NOVAS32Dll, EntryPoint:="local_planet")> Private Shared Function local_planet32(ByVal tjd As float, _
                                                                                                   ByRef ss_object As BodyDescriptionShort, _
                                                                                                   ByRef earth As BodyDescriptionShort, _
                                                                                                   ByVal deltat As float, _
                                                                                                   ByRef location As SiteInfo, _
                                                                                                   ...
                                                                                                   ByRef dis As float) As Short
        End Function
        <DllImport(NOVAS32Dll, EntryPoint:="astro_star")> Private Shared Function astro_star32(ByVal tjd As float, _
                                                                                               ByRef earth As BodyDescriptionShort, _
                                                                                               ByRef star As CatEntryNOVAS2, _
                                                                                               ByRef ra As float, _
                                                                                               ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS32Dll, EntryPoint:="astro_planet")> Private Shared Function astro_planet32(ByVal tjd As float, _
                                                                                                   ByRef ss_object As BodyDescriptionShort, _
                                                                                                   ByRef earth As BodyDescriptionShort, _
                                                                                                   ByRef ra As float, _
                                                                                                   ByRef dec As float, _
                                                                                                   ByRef dis As float) As Short
        End Function
        <DllImport(NOVAS32Dll, EntryPoint:="equ2hor")> Private Shared Sub equ2hor32(ByVal tjd As float, _
                                                                                    ByVal deltat As float, _
                                                                                    ByVal x As float, _
                                                                                    ByVal y As float, _
                                                                                    ByRef location As SiteInfo, _
        ...
        End Sub
        <DllImport(NOVAS32Dll, EntryPoint:="sidereal_time")> Private Shared Sub sidereal_time32(ByVal jd_high As float, _
                                                                                                ByVal jd_low As float, _
                                                                                                ByVal ee As float, _
                                                                                                ByRef gst As float)
        End Sub
        <DllImport(NOVAS32Dll, EntryPoint:="precession")> Private Shared Sub precession32(ByVal tjd1 As float, _
                                                                                          ByRef pos As PosVector2, _
                                                                                          ByVal tjd2 As float, _
                                                                                          ByRef pos2 As PosVector2)
        End Sub
        <DllImport(NOVAS32Dll, EntryPoint:="earthtilt")> Private Shared Sub earthtilt32(ByVal tjd As float, _
                                                                                        ByRef mobl As float, _
                                                                                        ByRef tobl As float, _
                                                                                        ByRef eq As float, _
                                                                                        ByRef dpsi As float, _
                                                                                        ByRef deps As float)
        End Sub
        <DllImport(NOVAS32Dll, EntryPoint:="cel_pole")> Private Shared Sub cel_pole32(ByVal del_dpsi As float, _
                                                                                      ByVal del_deps As float)
        End Sub
        <DllImport(NOVAS32Dll, EntryPoint:="ephemeris")> _
        Private Shared Function ephemeris32(ByVal tjd As float, _
        ...
        Private Shared Function Vector2radec32(ByRef pos As PosVector2, _
                                               ByRef ra As float, _
                                               ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS32Dll, EntryPoint:="starVector2s")> _
        Private Shared Sub starVector2s32(ByRef star As CatEntryNOVAS2, _
                                         ByRef pos As PosVector2, _
                                         ByRef vel As VelVector2)
        End Sub

        <DllImport(NOVAS32Dll, EntryPoint:="radec2Vector2")> _
        Private Shared Sub radec2Vector232(ByVal ra As float, _
                                          ByVal dec As float, _
                                          ByVal dist As float, _
                                          ByRef pos As PosVector2)
        End Sub
        <DllImport(NOVAS32Dll, EntryPoint:="get_earth")> _
        Private Shared Function get_earth32(ByVal tjd As float, _
                                            ByRef earth As BodyDescriptionShort, _
                                            ByRef tdb As float, _
                                            ByRef bary_earthp As PosVector2, _
                                            ByRef bary_earthv As VelVector2, _
                                            ByRef helio_earthp As PosVector2, _
                                            ByRef helio_earthv As VelVector2) As Short
        End Function
        '
        'START OF NEW
        '
        <DllImport(NOVAS32Dll, EntryPoint:="mean_star")> _
        Private Shared Function mean_star32(ByVal tjd As float, _
                                            ByRef earth As BodyDescriptionShort, _
                                            ByVal ra As float, _
                                            ByVal dec As float, _
                                            ByRef mra As float, _
        ...
        Private Shared Sub pnsw32(ByVal tjd As float, _
                                  ByVal gast As float, _
                                  ByVal x As float, _
                                  ByVal y As float, _
                                  ByRef vece As PosVector2, _
                                  ByRef vecs As PosVector2)
        End Sub
        <DllImport(NOVAS32Dll, EntryPoint:="spin")> _
        Private Shared Sub spin32(ByVal st As float, _
                                  ByRef pos1 As PosVector2, _
                                  ByRef pos2 As PosVector2)
        End Sub

        <DllImport(NOVAS32Dll, EntryPoint:="wobble")> _
        Private Shared Sub wobble32(ByVal x As float, _
                                    ByVal y As float, _
                                    ByRef pos1 As PosVector2, _
                                    ByRef pos2 As PosVector2)
        End Sub
        ...
        Private Shared Sub proper_motion32(ByVal tjd1 As float, _
                                           ByRef pos As PosVector2, _
                                           ByRef vel As VelVector2, _
                                           ByVal tjd2 As float, _
                                           ByRef pos2 As PosVector2)
        End Sub
        <DllImport(NOVAS32Dll, EntryPoint:="bary_to_geo")> _
        Private Shared Sub bary_to_geo32(ByRef pos As PosVector2, _
                                         ByRef earthVector2 As PosVector2, _
                                         ByRef pos2 As PosVector2, _
                                         ByRef lighttime As float)
        End Sub
        <DllImport(NOVAS32Dll, EntryPoint:="sun_field")> _
        Private Shared Function sun_field32(ByRef pos As PosVector2, _
                                            ByRef earthVector2 As PosVector2, _
                                            ByRef pos2 As PosVector2) As Short
        End Function


        <DllImport(NOVAS32Dll, EntryPoint:="aberration")> _
        Private Shared Function aberration32(ByRef pos As PosVector2, _
                                             ByRef vel As VelVector2, _
                                             ByVal lighttime As float, _
                                             ByRef pos2 As PosVector2) As Short
        End Function
        ...
        Private Shared Function nutate32(ByVal tjd As float, _
                                         ByVal fn As Short, _
                                         ByRef pos As PosVector2, _
                                         ByRef pos2 As PosVector2) As Short
        End Function
        ...
        Private Shared Function nutation_angles32(ByVal tdbtime As float, _
                                                  ByRef longnutation As float, _
                                                  ByRef obliqnutation As float) As Short
        End Function
        ...
        Private Shared Sub fund_args32(ByVal t As float, _
                                       ByRef a As FundamentalArgs)
        End Sub
        <DllImport(NOVAS32Dll, EntryPoint:="tdb2tdt")> _
        Private Shared Sub tdb2tdt32(ByVal tdb As float, _
                                     ByRef tdtjd As float, _
                                     ByRef secdiff As float)
        End Sub
        ...
        Private Shared Sub cal_date32(ByVal tjd As float, _
                                      ByRef year As Short, _
                                      ByRef month As Short, _
                                      ByRef day As Short, _
                                      ByRef hour As float)
        ...
        Private Shared Sub sun_eph32(ByVal jd As float, _
                                          ByRef ra As float, _
                                          ByRef dec As float, _
                                          ByRef dis As float)
        End Sub
...
#Region "DLL Entry Points (64bit)"
        <DllImport(NOVAS64Dll, EntryPoint:="app_star")> Private Shared Function app_star64(ByVal tjd As float, _
                                                                                           ByRef earth As BodyDescriptionShort, _
                                                                                           ByRef star As CatEntryNOVAS2, _
                                                                                           ByRef ra As float, _
                                                                                           ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS64Dll, EntryPoint:="topo_star")> Private Shared Function topo_star64(ByVal tjd As float, _
                                                                                             ByRef earth As BodyDescriptionShort, _
                                                                                             ByVal deltat As float, _
                                                                                             ByRef star As CatEntryNOVAS2, _
                                                                                             ByRef location As SiteInfo, _
                                                                                             ...
                                                                                             ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS64Dll, EntryPoint:="app_planet")> Private Shared Function app_planet64(ByVal tjd As float, _
                                                                                               ByRef ss_object As BodyDescriptionShort, _
                                                                                               ByRef earth As BodyDescriptionShort, _
                                                                                               ByRef ra As float, _
                                                                                               ByRef dec As float, _
                                                                                               ByRef dis As float) As Short
        End Function
        <DllImport(NOVAS64Dll, EntryPoint:="topo_planet")> Private Shared Function topo_planet64(ByVal tjd As float, _
                                                                                                 ByRef ss_object As BodyDescriptionShort, _
                                                                                                 ByRef earth As BodyDescriptionShort, _
                                                                                                 ByVal deltat As float, _
                                                                                                 ByRef location As SiteInfo, _
                                                                                                 ...
                                                                                                 ByRef dis As float) As Short
        End Function
        <DllImport(NOVAS64Dll, EntryPoint:="virtual_star")> Private Shared Function virtual_star64(ByVal tjd As float, _
                                                                                                   ByRef earth As BodyDescriptionShort, _
                                                                                                   ByRef star As CatEntryNOVAS2, _
                                                                                                   ByRef ra As float, _
                                                                                                   ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS64Dll, EntryPoint:="local_star")> Private Shared Function local_star64(ByVal tjd As float, _
                                                                                               ByRef earth As BodyDescriptionShort, _
                                                                                               ByVal deltat As float, _
                                                                                               ByRef star As CatEntryNOVAS2, _
                                                                                               ByRef location As SiteInfo, _
                                                                                               ...
                                                                                               ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS64Dll, EntryPoint:="virtual_planet")> Private Shared Function virtual_planet64(ByVal tjd As float, _
                                                                                                       ByRef ss_object As BodyDescriptionShort, _
                                                                                                       ByRef earth As BodyDescriptionShort, _
                                                                                                       ByRef ra As float, _
                                                                                                       ByRef dec As float, _
                                                                                                       ByRef dis As float) As Short
        End Function
        <DllImport(NOVAS64Dll, EntryPoint:="local_planet")> Private Shared Function local_planet64(ByVal tjd As float, _
                                                                                                   ByRef ss_object As BodyDescriptionShort, _
                                                                                                   ByRef earth As BodyDescriptionShort, _
                                                                                                   ByVal deltat As float, _
                                                                                                   ByRef location As SiteInfo, _
                                                                                                   ...
                                                                                                   ByRef dis As float) As Short
        End Function
        <DllImport(NOVAS64Dll, EntryPoint:="astro_star")> Private Shared Function astro_star64(ByVal tjd As float, _
                                                                                               ByRef earth As BodyDescriptionShort, _
                                                                                               ByRef star As CatEntryNOVAS2, _
                                                                                               ByRef ra As float, _
                                                                                               ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS64Dll, EntryPoint:="astro_planet")> Private Shared Function astro_planet64(ByVal tjd As float, _
                                                                                                   ByRef ss_object As BodyDescriptionShort, _
                                                                                                   ByRef earth As BodyDescriptionShort, _
                                                                                                   ByRef ra As float, _
                                                                                                   ByRef dec As float, _
                                                                                                   ByRef dis As float) As Short
        End Function
        <DllImport(NOVAS64Dll, EntryPoint:="equ2hor")> Private Shared Sub equ2hor64(ByVal tjd As float, _
                                                                                    ByVal deltat As float, _
                                                                                    ByVal x As float, _
                                                                                    ByVal y As float, _
                                                                                    ByRef location As SiteInfo, _
        ...
        <DllImport(NOVAS64Dll, EntryPoint:="transform_cat")> Private Shared Sub transform_cat64(ByVal [option] As Short, _
                                                                                                ...
                                                                                                ByRef newcat As CatEntryNOVAS2)
        End Sub
        <DllImport(NOVAS64Dll, EntryPoint:="sidereal_time")> Private Shared Sub sidereal_time64(ByVal jd_high As float, _
                                                                                                ByVal jd_low As float, _
                                                                                                ByVal ee As float, _
                                                                                                ByRef gst As float)
        End Sub
        <DllImport(NOVAS64Dll, EntryPoint:="precession")> Private Shared Sub precession64(ByVal tjd1 As float, _
                                                                                          ByRef pos As PosVector2, _
                                                                                          ByVal tjd2 As float, _
                                                                                          ByRef pos2 As PosVector2)
        End Sub
        <DllImport(NOVAS64Dll, EntryPoint:="earthtilt")> Private Shared Sub earthtilt64(ByVal tjd As float, _
                                                                                        ByRef mobl As float, _
                                                                                        ByRef tobl As float, _
                                                                                        ByRef eq As float, _
                                                                                        ByRef dpsi As float, _
                                                                                        ByRef deps As float)
        End Sub
        <DllImport(NOVAS64Dll, EntryPoint:="cel_pole")> Private Shared Sub cel_pole64(ByVal del_dpsi As float, _
                                                                                    ByVal del_deps As float)
        End Sub
        <DllImport(NOVAS64Dll, EntryPoint:="ephemeris")> _
        Private Shared Function ephemeris64(ByVal tjd As float, _
                                       ByRef cel_obj As BodyDescriptionShort, _
                                       ByVal origin As Short, _
                                       ByRef pos As PosVector2, _
                                       ByRef vel As VelVector2) As Short
        ...
        Private Shared Function solarsystem64(ByVal tjd As float, _
                                              ByVal body As Short, _
                                              ByVal origin As Short, _
                                              ByRef pos As PosVector2, _
                                              ByRef vel As VelVector2) As Short
        ...
        Private Shared Function Vector2radec64(ByRef pos As PosVector2, _
                                               ByRef ra As float, _
                                               ByRef dec As float) As Short
        End Function
        <DllImport(NOVAS64Dll, EntryPoint:="starVector2s")> _
        Private Shared Sub starVector2s64(ByRef star As CatEntryNOVAS2, _
                                         ByRef pos As PosVector2, _
                                         ByRef vel As VelVector2)
        End Sub
        <DllImport(NOVAS64Dll, EntryPoint:="radec2Vector2")> _
        Private Shared Sub radec2Vector264(ByVal ra As float, _
                                          ByVal dec As float, _
                                          ByVal dist As float, _
                                          ByRef pos As PosVector2)
        End Sub
        <DllImport(NOVAS64Dll, EntryPoint:="get_earth")> _
        Private Shared Function get_earth64(ByVal tjd As float, _
                                        ByRef earth As BodyDescriptionShort, _
                                        ByRef tdb As float, _
                                        ByRef bary_earthp As PosVector2, _
                                        ByRef bary_earthv As VelVector2, _
        ...
        Private Shared Function mean_star64(ByVal tjd As float, _
                                            ByRef earth As BodyDescriptionShort, _
                                            ByVal ra As float, _
                                            ByVal dec As float, _
                                            ByRef mra As float, _
        ...
        Private Shared Sub pnsw64(ByVal tjd As float, _
                                  ByVal gast As float, _
                                  ByVal x As float, _
                                  ByVal y As float, _
                                  ByRef vece As PosVector2, _
        ...
        Private Shared Sub spin64(ByVal st As float, _
                                  ByRef pos1 As PosVector2, _
                                  ByRef pos2 As PosVector2)
        End Sub

        <DllImport(NOVAS64Dll, EntryPoint:="wobble")> _
        Private Shared Sub wobble64(ByVal x As float, _
                                    ByVal y As float, _
                                    ByRef pos1 As PosVector2, _
                                    ByRef pos2 As PosVector2)
        End Sub
        ...
        Private Shared Sub proper_motion64(ByVal tjd1 As float, _
                                           ByRef pos As PosVector2, _
                                           ByRef vel As VelVector2, _
                                           ByVal tjd2 As float, _
                                           ByRef pos2 As PosVector2)
        ...
        Private Shared Sub bary_to_geo64(ByRef pos As PosVector2, _
                                         ByRef earthVector2 As PosVector2, _
                                         ByRef pos2 As PosVector2, _
                                         ByRef lighttime As float)
        End Sub
        <DllImport(NOVAS64Dll, EntryPoint:="sun_field")> _
        Private Shared Function sun_field64(ByRef pos As PosVector2, _
                                            ByRef earthVector2 As PosVector2, _
                                            ByRef pos2 As PosVector2) As Short
        End Function
        ...
        Private Shared Function aberration64(ByRef pos As PosVector2, _
                                             ByRef vel As VelVector2, _
                                             ByVal lighttime As float, _
                                             ByRef pos2 As PosVector2) As Short
        End Function
        ...
        Private Shared Function nutate64(ByVal tjd As float, _
                                         ByVal fn As Short, _
                                         ByRef pos As PosVector2, _
                                         ByRef pos2 As PosVector2) As Short
        End Function
        ...
        Private Shared Function nutation_angles64(ByVal tdbtime As float, _
                                                  ByRef longnutation As float, _
                                                  ByRef obliqnutation As float) As Short
        End Function

        <DllImport(NOVAS64Dll, EntryPoint:="fund_args")> _
        Private Shared Sub fund_args64(ByVal t As float, _
                                       ByRef a As FundamentalArgs)
        End Sub
        <DllImport(NOVAS64Dll, EntryPoint:="tdb2tdt")> _
        Private Shared Sub tdb2tdt64(ByVal tdb As float, _
                                     ByRef tdtjd As float, _
                                     ByRef secdiff As float)
        End Sub
        ...
        Private Shared Sub cal_date64(ByVal tjd As float, _
                                    ByRef year As Short, _
                                    ByRef month As Short, _
                                    ByRef day As Short, _
                                    ByRef hour As float)
        ...
        Private Shared Sub sun_eph64(ByVal jd As float, _
                                          ByRef ra As float, _
                                          ByRef dec As float, _
                                          ByRef dis As float)
        End Sub
...
#Region "Support Code"
        ...
        Private Shared Function ArrToPosVec(ByVal Arr As float()) As PosVector2
            'Create a new Vector2 having the values in the supplied float array
            Dim V As New PosVector2
            V.x = Arr(0)
            V.y = Arr(1)
            V.z = Arr(2)
            Return V
        ...
        Private Shared Sub PosVecToArr(ByVal V As PosVector2, ByRef Ar As float())
        ...
        Private Shared Function ArrToVelVec(ByVal Arr As float()) As VelVector2
            'Create a new Vector2 having the values in the supplied float array
            Dim V As New VelVector2
            V.x = Arr(0)
            V.y = Arr(1)
            V.z = Arr(2)
            Return V
        ...
        Private Shared Sub VelVecToArr(ByVal V As VelVector2, ByRef Ar As float())
            'Copy a Vector2 structure to a returned float array
            Ar(0) = V.x
            Ar(1) = V.y
            Ar(2) = V.z
