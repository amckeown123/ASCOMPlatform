...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// <summary>
        /// This function rotates a Vector2 from the celestial to the terrestrial system.  Specifically, it transforms a Vector2 in the
        ...
        /// Vector2 is produced with respect to the equator and equinox of date. (See note 2 below)</param>
        ...
        /// ITRS pole, in arcseconds.</param>
        /// <param name="VecT">Position Vector2, geocentric equatorial rectangular coordinates,
        /// referred to GCRS axes (celestial system) or with respect to
        /// the equator and equinox of date, depending on 'option'.</param>
        /// <param name="VecC">Position Vector2, geocentric equatorial rectangular coordinates,
        ...
        /// </para></remarks>
        public short Cel2Ter(float JdHigh, float JdLow, float DeltaT, Method Method, Accuracy Accuracy, OutputVector2Option OutputOption, float xp, float yp, float[] VecT, ref float[] VecC)
        {
        ...
        public void Equ2Hor(float Jd_Ut1, float DeltT, Accuracy Accuracy, float xp, float yp, OnSurface Location, float Ra, float Dec, RefractionOption RefOption, ref float Zd, ref float Az, ref float RaR, ref float DecR)
        {
            try
            {
        ...
        /// </para></remarks>
        public short Ter2Cel(float JdHigh, float JdLow, float DeltaT, Method Method, Accuracy Accuracy, OutputVector2Option OutputOption, float xp, float yp, float[] VecT, ref float[] VecC)
        {
            var VVecC = new PosVector2();
            short rc;
            if (Is64Bit())
        ...
        /// <remarks></remarks>
        public void Wobble(float Tjd, TransformationDirection Direction, float xp, float yp, float[] Pos1, ref float[] Pos2)
        {
            var VPos2 = new PosVector2();
        ...
        private short Ephem_Open(string Ephem_Name, ref float JD_Begin, ref float JD_End, ref short DENumber)
        {
        ...
        private static extern short EphemOpen32([MarshalAs(UnmanagedType.LPStr)] string Ephem_Name, ref float JD_Begin, ref float JD_End, ref short DENumber);
        ...
        private static extern IntPtr ReadEph32(int Mp, [MarshalAs(UnmanagedType.LPStr)] string Name, float Jd, ref int Err);
        ...
        private static extern void Aberration32(ref PosVector2 Pos, ref VelVector2 Vel, float LightTime, ref PosVector2 Pos2);
        ...
        private static extern void Bary2Obs32(ref PosVector2 Pos, ref PosVector2 PosObs, ref PosVector2 Pos2, ref float Lighttime);
        ...
        private static extern short Cel2Ter32(float JdHigh, float JdLow, float DeltaT, Method Method, Accuracy Accuracy, OutputVector2Option OutputOption, float x, float y, ref PosVector2 VecT, ref PosVector2 VecC);

        [DllImport(NOVAS32DLL, EntryPoint = "cel_pole")]
        private static extern short CelPole32(float Tjd, PoleOffsetCorrection Type, float Dpole1, float Dpole2);
        ...
        private static extern short CioLocation32(float JdTdb, Accuracy Accuracy, ref float RaCio, ref ReferenceSystem RefSys);
        ...
        private static extern void Equ2Gal32(float RaI, float DecI, ref float GLon, ref float GLat);
        ...
        private static extern float JulianDate32(short Year, short Month, short Day, float Hour);
        ...
        private static extern void LimbAngle32(ref PosVector2 PosObj, ref PosVector2 PosObs, ref float LimbAng, ref float NadirAng);

        [DllImport(NOVAS32DLL, EntryPoint = "local_planet")]
        private static extern short LocalPlanet32(float JdTt, ref Object3Internal SsBody, float DeltaT, ref OnSurface Position, Accuracy Accuracy, ref float Ra, ref float Dec, ref float Dis);
        ...
        private static extern void NutationAngles32(float t, Accuracy Accuracy, ref float DPsi, ref float DEps);
        ...
        private static extern short Precession32(float JdTdb1, ref PosVector2 Pos1, float JdTdb2, ref PosVector2 Pos2);
        ...
        private static extern void RadVel32(ref Object3Internal CelObject, ref PosVector2 Pos, ref VelVector2 Vel, ref VelVector2 VelObs, float DObsGeo, float DObsSun, float DObjSun, ref float Rv);

        [DllImport(NOVAS32DLL, EntryPoint = "radec2Vector2")]
        private static extern void RaDec2Vector232(float Ra, float Dec, float Dist, ref PosVector2 Vector2);
        ...
        private static extern void Terra32(ref OnSurface Location, float St, ref PosVector2 Pos, ref VelVector2 Vel);

        [DllImport(NOVAS32DLL, EntryPoint = "topo_planet")]
        private static extern short TopoPlanet32(float JdTt, ref Object3Internal SsBody, float DeltaT, ref OnSurface Position, Accuracy Accuracy, ref float Ra, ref float Dec, ref float Dis);
        ...
        private static extern void Wobble32(float Tjd, short Direction, float x, float y, ref PosVector2 Pos1, ref PosVector2 Pos2);
        #endregion
        ...
        private static extern short EphemOpen64([MarshalAs(UnmanagedType.LPStr)] string Ephem_Name, ref float JD_Begin, ref float JD_End, ref short DENumber);
        ...
        private static extern IntPtr ReadEph64(int Mp, [MarshalAs(UnmanagedType.LPStr)] string Name, float Jd, ref int Err);
        ...
        private static extern void Aberration64(ref PosVector2 Pos, ref VelVector2 Vel, float LightTime, ref PosVector2 Pos2);
        ...
        private static extern void Bary2Obs64(ref PosVector2 Pos, ref PosVector2 PosObs, ref PosVector2 Pos2, ref float Lighttime);
        ...
        private static extern short Cel2Ter64(float JdHigh, float JdLow, float DeltaT, Method Method, Accuracy Accuracy, OutputVector2Option OutputOption, float x, float y, ref PosVector2 VecT, ref PosVector2 VecC);

        [DllImport(NOVAS64DLL, EntryPoint = "cel_pole")]
        private static extern short CelPole64(float Tjd, PoleOffsetCorrection Type, float Dpole1, float Dpole2);
        ...
        private static extern short CioLocation64(float JdTdb, Accuracy Accuracy, ref float RaCio, ref ReferenceSystem RefSys);
        ...
        private static extern void Equ2Gal64(float RaI, float DecI, ref float GLon, ref float GLat);
        ...
        private static extern float JulianDate64(short Year, short Month, short Day, float Hour);
        ...
        private static extern void LimbAngle64(ref PosVector2 PosObj, ref PosVector2 PosObs, ref float LimbAng, ref float NadirAng);

        [DllImport(NOVAS64DLL, EntryPoint = "local_planet")]
        private static extern short LocalPlanet64(float JdTt, ref Object3Internal SsBody, float DeltaT, ref OnSurface Position, Accuracy Accuracy, ref float Ra, ref float Dec, ref float Dis);
        ...
        private static extern void NutationAngles64(float t, Accuracy Accuracy, ref float DPsi, ref float DEps);
        ...
        private static extern short Precession64(float JdTdb1, ref PosVector2 Pos1, float JdTdb2, ref PosVector2 Pos2);
        ...
        private static extern void RadVel64(ref Object3Internal CelObject, ref PosVector2 Pos, ref VelVector2 Vel, ref VelVector2 VelObs, float DObsGeo, float DObsSun, float DObjSun, ref float Rv);

        [DllImport(NOVAS64DLL, EntryPoint = "radec2Vector2")]
        private static extern void RaDec2Vector264(float Ra, float Dec, float Dist, ref PosVector2 Vector2);
        ...
        private static extern void Terra64(ref OnSurface Location, float St, ref PosVector2 Pos, ref VelVector2 Vel);

        [DllImport(NOVAS64DLL, EntryPoint = "topo_planet")]
        private static extern short TopoPlanet64(float JdTt, ref Object3Internal SsBody, float DeltaT, ref OnSurface Position, Accuracy Accuracy, ref float Ra, ref float Dec, ref float Dis);
        ...
        private static extern void Wobble64(float Tjd, short Direction, float x, float y, ref PosVector2 Pos1, ref PosVector2 Pos2);
        #endregion
